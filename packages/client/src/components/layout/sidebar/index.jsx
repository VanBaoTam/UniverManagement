...
import { PERMISSIONS, SIDEBAR_ADMINS, SIDEBAR_INSTRUCTORS, SIDEBAR_STUDENTS } from "../../../constants/common";
          ...
          <NavLink
            ...
            style={({ isActive, isPending, isTransitioning }) => {
              return {
                ...
                background: isActive ? "linear-gradient(45deg, #85FFBD 0%, #d3ff7d 100%)" : "",
